...
<body <?php body_class("site"); ?>>
    <header class="site__header">
        ...
        <section class="site__header__navigation">
            ...
            <div class="site__header__navigation__menu">
                <span class="site__header__navigation__menu__ouverture">
                    <svg width="50px" height="50px" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" color="rgb(221, 255, 0)"><path clip-rule="evenodd" d="M0 0h24v24H0z" fill="none"></path><path d="M22.7 19l-9.1-9.1c.9-2.3.4-5-1.5-6.9-2-2-5-2.4-7.4-1.3L9 6 6 9 1.6 4.7C.4 7.1.9 10.1 2.9 12.1c1.9 1.9 4.6 2.4 6.9 1.5l9.1 9.1c.4.4 1 .4 1.4 0l2.3-2.3c.5-.4.5-1.1.1-1.4z"></path></svg>
                </span>
                <?php
                    wp_nav_menu(array(
                        "menu" => "ateliers",
                        "container" => "nav",
                        "container_class" => "site__header__navigation__menu__nav menu__ateliers",
                    ));
                ?>
            </div>
        </section>
